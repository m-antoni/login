<div class="form-group row">
   	<div class="col-md-3">
        <label>First:</label>
        <input id="first" type="text" name="first" class="form-control{{ $errors->has('first') ? ' is-invalid' : '' }}" 
    ...
    <div class="col-md-3">
        <label>Last:</label>
        <input id="last" type="text" name="last" class="form-control{{ $errors->has('last') ? ' is-invalid' : '' }}" 
    ...
    <div class="col-md-3">
        <label>Middle:</label>
        <input id="middle" type="text" name="middle" class="form-control" value="{{ old('middle') ?? $register->middle}}">
    </div>
...
<div class="form-group row">
	...
	<div class="col-md-3">	
     <label>Birthday:</label>
        <input id="birthday" type="date" name="birthday" class="form-control{{ $errors->has('birthday') ? ' is-invalid' : '' }}" 
	...
	<div class="col-md-3">	
     <label>Contact:</label>
        <input id="contact" type="text" name="contact" class="form-control{{ $errors->has('contact') ? ' is-invalid' : '' }}" 
...
<div class="form-group row">
	<div class="col-md-4">
      <label>Address:</label>
      <textarea id="address" name="address" class="form-control{{ $errors->has('address') ? ' is-invalid' : '' }}">{{ old('address') ?? $register->address}}</textarea>
    ...
    <div class="col-md-4">
  	...
  	<div class="col-md-4">	
        ...
        <input id="date_hired" type="date" name="date_hired" class="form-control{{ $errors->has('date_hired') ? ' is-invalid' : '' }}" value="{{ old('date_hired') ?? $register->date_hired }}">
...
<div class="form-group row">
	<div class="col-md-4">
        ...
        <input id="id_number" type="text" name="id_number" class="form-control{{ $errors->has('id_number') ? ' is-invalid' : '' }}" 
